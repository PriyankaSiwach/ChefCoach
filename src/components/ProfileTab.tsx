...
const mealSplit = { Breakfast: 0.25, Lunch: 0.35, Dinner: 0.35 } as const;
...
export function ProfileTab({
  ...
  const cards: Array<"Breakfast" | "Lunch" | "Dinner"> = ["Breakfast", "Lunch", "Dinner"];
  ...
  return (
    <main className="pb-24 md:pb-10">
      <section className="mx-auto max-w-[920px] px-5 pt-6">
        <div className="relative rounded-3xl bg-gradient-to-r from-[var(--green)] to-[var(--green-light)] p-5 text-[var(--cream)]">
          <button
            ...
            className="absolute right-4 top-4 rounded-full border border-white/80 bg-transparent px-3 py-1.5 text-xs font-semibold text-white shadow-sm"
          >
            ✏️ Edit
          </button>
      ...
      <section className="mx-auto max-w-[920px] px-5 pt-4">
      ...
      <section className="mx-auto max-w-[920px] px-5 pt-6">
        <div className="space-y-6">
          <div>
            <h2 className="font-playfair text-xl text-[var(--green)]">Daily progress rings</h2>
      ...
      <section className="mx-auto max-w-[920px] px-5 pt-6">
        <h2 className="font-playfair text-3xl text-[var(--green)]">Your Progress</h2>
      ...
      <section className="mx-auto max-w-[920px] px-5 pt-6">
        <h2 className="font-playfair text-3xl text-[var(--green)]">Today&apos;s meal plan</h2>
      ...
      <section className="mx-auto max-w-[920px] px-5 pt-6">
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--white)] p-4">
          <h3 className="font-playfair text-2xl text-[var(--green)]">💧 Daily water intake</h3>
      ...
      <section className="mx-auto max-w-[920px] space-y-4 px-5 pt-8 pb-28 text-center md:pb-12">
        ...
        <button
          ...
          className="text-xs text-[var(--gray)] underline decoration-[var(--gray)]/50 underline-offset-2 transition hover:text-[var(--text)]"
        >
          ← Start over / Reset account
        </button>
      </section>
      ...
      {resetConfirmOpen ? (
        ...
        >
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            <p id="reset-account-title" className="font-playfair text-lg text-[var(--green)]">
              Reset account?
            </p>
            <p className="mt-3 text-sm leading-relaxed text-[var(--gray)]">
              This will clear all your data and restart setup. Are you sure?
            </p>
